export const categoryPageContent = [
  ...
  },
  {
    ...
    tools: ["document-scanner", "pdf-compressor", "pdf-merger", "pdf-splitter", "pdf-page-rotator", "pdf-page-extractor", "pdf-watermark-adder", "pdf-to-image-converter", "pdf-blank-page-remover", "pdf-page-number", "pdf-header-footer-adder", "pdf-qr-code-adder", "pdf-bookmark-creator", "pdf-to-word", "edit-pdf-online"],
